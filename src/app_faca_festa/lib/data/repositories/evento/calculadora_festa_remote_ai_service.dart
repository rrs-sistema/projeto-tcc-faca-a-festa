...
import '../i_calculadora_festa_ai_service.dart';
...
typedef CalculadoraFestaAIRemoteExecutor = Future<Map<String, dynamic>> Function(
  ...
  Map<String, dynamic> _montarPayload({
    ...
    return {
      ...
      'convidados': {
        ...
        'total_equivalente_arredondado': estimativa.convidados.totalEquivalenteArredondado,
      },
