  ...
  Future<void> registrarUsuario() async {
    ...
    try {
      ...
      await _perfilUsuarioRepository.salvarUsuarioCadastro(
        novoUsuario,
        emailNormalizado: _normalizarEmail(email.value),
      );
      ...
      if (deveSalvarEndereco) {
        await _perfilUsuarioRepository.salvarEndereco(endereco);
  ...
  Future<void> registrarComGoogle() async {
    ...
    try {
      ...
      final usuarioExistente =
          await _perfilUsuarioRepository.buscarUsuario(uid);
      ...
      if (usuarioExistente == null) {
        ...
        await _perfilUsuarioRepository.salvarUsuarioCadastro(
          novoUsuario,
          emailNormalizado: _normalizarEmail(emailGoogle),
          provider: 'google',
        );
