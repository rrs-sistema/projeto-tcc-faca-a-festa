...
class FinanceiroSection extends StatelessWidget {
  ...
  static final Rx<TipoVisualizacao> _tipoVisualizacao =
      TipoVisualizacao.semana.obs;
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return PremiumSectionShell(
        ...
        subtitle:
            'Receita, oportunidades abertas e evolução de contratos fechados.',
          ...
          children: [
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                final categorias =
                    _CategoriasReceita(categorias: resumoCategorias);
  ...
  static List<Map<String, dynamic>> _gerarHistoricoSemanal(
    ...
    return List.generate(
        5, (i) => {'semana': i + 1, 'valor': agrupado[i + 1] ?? 0.0});
  }

  static List<Map<String, dynamic>> _gerarHistoricoMensal(
      OrcamentoController controller) {
    final orcs = controller.orcamentos
        .where((o) =>
            o.status == StatusOrcamento.fechado && o.dataFechamento != null)
        .toList();
    final agrupado = <int, double>{};
    for (final o in orcs) {
  ...
  static List<OrcamentoModel> _pegarContratosRecentes(
      List<OrcamentoModel> orcs) {
    final fechados = orcs
        .where((o) =>
            o.status == StatusOrcamento.fechado && o.dataFechamento != null)
        .toList()
...
class _GraficoComCabecalho extends StatelessWidget {
  ...
  const _GraficoComCabecalho(
      {required this.tipoVisualizacao, required this.controller});
              ...
              builder: (context, constraints) {
                ...
                final dropdown = Container(
                  ...
                  child: DropdownButton<TipoVisualizacao>(
                    ...
                    items: const [
                      DropdownMenuItem(
                          value: TipoVisualizacao.semana,
                          child: Text('Semanal')),
                      DropdownMenuItem(
                          value: TipoVisualizacao.mes, child: Text('Mensal')),
                    ],
                  ),
                );
    ...
    if (!temValor) {
      return const SizedBox(
        ...
        child: PremiumEmptyState(
          ...
          message:
              'Quando contratos forem fechados, a evolução financeira aparecerá aqui.',
            ...
            leftTitles: AxisTitles(
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (v, _) => Text(
                  'R\$${v.toInt()}',
                  style: GoogleFonts.poppins(
                      fontSize: 9.5, color: FornecedorPremiumPalette.softMuted),
                ),
              ),
            ),
            topTitles:
    ...
    return _MiniPanel(
      ...
      child: Column(
        ...
        children: contratos.map((o) {
          ...
          final data = o.dataFechamento != null
  ...
  Widget build(BuildContext context) {
    if (categorias.isEmpty) {
      return const PremiumEmptyState(
        ...
        message:
            'Ao fechar contratos, a distribuição por categoria será exibida aqui.',
        color: FornecedorPremiumPalette.primary,
      );
    }
    ...
    return _MiniPanel(
      ...
      child: Column(
        ...
        children: categorias.entries.map((e) {
          final percentual =
              total == 0 ? 0.0 : (e.value / total).clamp(0.0, 1.0).toDouble();
          return Padding(
