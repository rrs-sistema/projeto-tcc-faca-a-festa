  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final estat = _montarEstatisticasMesas(
          grupos: grupos, grupoController: grupoController);
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
            ...
            runSpacing: 8,
            children: resumo
                .map((r) => _metricCard(context, r["label"] as String,
                    r["value"].toString(), r["color"] as Color))
                .toList()),
      ],
    );
  }
      ...
      children: [
        ...
        SizedBox(
            ...
            child: PieChart(PieChartData(
                ...
                sections: [
                  _pieSection(
                      "Ocupados", totalOcupados / totalAssentos, Colors.teal),
                  _pieSection("Livres", totalLivres / totalAssentos,
                      Colors.orangeAccent)
                ]))),
        const SizedBox(height: 12),
