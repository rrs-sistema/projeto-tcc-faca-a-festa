import { CalculadoraIARequest } from "./types";
...
export function buildInstructions(): string {
  return [
    ...
    "Use apenas os dados recebidos no payload como fonte de verdade.",
    "Gere recomendações práticas, objetivas e úteis para organização de eventos.",
    "Considere orçamento disponível, custo estimado, duração, perfil da festa, tipo de evento, adultos, crianças, bebês e itens calculados.",
...
export function buildInput(request: CalculadoraIARequest): string {
